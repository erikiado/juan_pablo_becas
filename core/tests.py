...
class ValidatorsTest(TestCase):
	...
	def test_bad_phone_number(self):
		...
		self.assertRaises(ValidationError, PHONE_REGEX, '0987654321123456') # 16 digit phone number
		self.assertRaises(ValidationError, PHONE_REGEX, '+521234567890123456') # 16 digit phone number with country code
		self.assertRaises(ValidationError, PHONE_REGEX, 'foo') # Random String
		self.assertRaises(ValidationError, PHONE_REGEX, '+52foo') # Random String with country code
