...
def forwards_func(apps, schema_editor):
    ...
    Tutorial.objects.using(db_alias).bulk_create([
        ...
        Tutorial(titulo='¿Cómo funciona la pestaña de estudios?',
                 ...
                 video='https://www.youtube.com/embed/e0E--BJMXaE',
                 seccion='administracion'),
        Tutorial(titulo='¿Cómo buscar a un niño?',
                 ...
                 video='https://www.youtube.com/embed/qMNpVpXuzyM',
                 seccion='administracion'),
        ...
        Tutorial(titulo='¿Cómo retroalimentar un estudio?',
                 ...
                 video='https://www.youtube.com/embed/Ev1E_lUxdoA',
                 seccion='administracion'),
        Tutorial(titulo='¿Cómo aprobar un estudio?',
                 ...
                 video='https://www.youtube.com/embed/X_6XJiQxUQ8',
                 seccion='administracion'),
        Tutorial(titulo='¿Cómo asignar una beca?',
                 descripcion='En este tutorial se muestra cómo se le otorga una beca a la familia.',
                 video='https://www.youtube.com/embed/kz4wrdmMeLE',
                 seccion='administracion'),
        # Tutorial(titulo='¿Cómo reasignar una beca?',
        #          descripcion='En este tutorial se muestra cómo cambiar la beca de una familia.',
        #          video='https://www.youtube.com/embed/dQw4w9WgXcQ',
        #          seccion='administracion'),
        Tutorial(titulo='¿Cómo generar la carta de beca de un niño?',
                 ...
                 video='https://www.youtube.com/embed/EaMfrDRH_5c',
                 seccion='administracion'),
        ...
        Tutorial(titulo='¿Creación de un nuevo estudio socioeconómico?',
                 ...
                 video='https://www.youtube.com/embed/rF_FiEEBJ44',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar al sección de integrantes?',
                 ...
                 video='https://www.youtube.com/embed/LA84jNnSHrI',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar los egresos e ingresos?',
                 ...
                 video='https://www.youtube.com/embed/8MG6BM71AZ0',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo subir las imágenes de la vivienda?',
                 ...
                 video='https://www.youtube.com/embed/Ps2ASEQnBDU',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar el resto del estudio socioeconómico?',
                 ...
                 video='https://www.youtube.com/embed/YRs8Wks09i0',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo subir el estudio a revisión?',
                 descripcion='En este tutorial se muestra cómo subir un estudio socioeconómico, y qué hay que checar antes de subirlo.',
                 video='https://www.youtube.com/embed/dyA0sMRwWq8',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo lidiar con el proceso de retroalimentación?',
                 ...
                 video='https://www.youtube.com/embed/elCHipaHUcI',
                 seccion='captura'),
