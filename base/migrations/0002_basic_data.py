...
def forwards_func(apps, schema_editor):
    ...
    Tutorial.objects.using(db_alias).bulk_create([
        Tutorial(titulo='¿Cómo hacer login por primera vez?',
                 descripcion='En este tutorial se muestra como hacer login una vez que el administrador crea tu cuenta.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='general'),
        Tutorial(titulo='¿Cómo hacer login a la página?',
                 descripcion='En este tutorial se muestra como entrar a tu cuenta.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='general'),
        Tutorial(titulo='¿Cómo hacer logout de la página?',
                 descripcion='En este tutorial se muestra como cerrar tu sesión.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='general'),
        Tutorial(titulo='¿Cómo recuperar tu contraseña?',
                 descripcion='En este tutorial se muestra como recuparar tu contraseña, en caso de que sea olvidada.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='general'),

        # Carga de sección de administración
        Tutorial(titulo='¿Cómo crear un nuevo usuario?',
                 descripcion='En este tutorial se muestra como crear un nuevo usuario.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
        ...
        Tutorial(titulo='¿Cómo retroalimentar un estudio?',
                 descripcion='En este tutorial se muestra como rechazar y retroalimentar un estudio.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='administracion'),
        Tutorial(titulo='¿Cómo aprovar un estudio?',
                 descripcion='En este tutorial se muestra como aprobar un estudio y los cambios que genera.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='administracion'),
        Tutorial(titulo='¿Cómo asignar una beca?',
                 descripcion='En este tutorial se muestra como se le otorga una beca a la familia.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='administracion'),
        ...
        Tutorial(titulo='¿Cómo generar la carta de beca de un niño?',
                 descripcion='En este tutorial se muestra como crear la carta de beca para un alumno.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='administracion'),

        # Carga de sección de capturista
        Tutorial(titulo='¿Creación de un nuevo estudio socioeconómico?',
                 descripcion='En este tutorial se muestra como crear un nuevo estudio socioeconómico.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar al sección de integrantes?',
                 descripcion='En este tutorial se muestra como llenar la sección de integrantes.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar los egresos e ingresos?',
                 descripcion='En este tutorial se muestra como desglosar los egresos e ingresos de la familia.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo subir las imágenes de la vivienda?',
                 descripcion='En este tutorial se muestra como subir las imágenes tomadas de la vivienda.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo llenar el resto del estudio socioeconómico?',
                 descripcion='En este tutorial se muestra como llenar el resto de la información de la familia.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo subir el estudio a revisión?',
                 ...
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Cómo lidear con el proceso de retroalimentación?',
                 descripcion='En este tutorial se explica como funciona el proceso de retroalimentación',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='captura'),
        Tutorial(titulo='¿Que significan los diferentes estados del estudio socioeconómico?',
        ...
        Tutorial(titulo='¿Cómo descargar el resumen completo de información de la plataforma?',
                 descripcion='En este tutorial se muestra como descargar un resumen total de los datos de la escuela.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
                 seccion='direccion'),

        # Carga de sección de servicios escolares
        Tutorial(titulo='¿Cómo marcar un alumno que ha empezado el proceso de reinscripción?',
                 descripcion='En este tutorial se muestra como marcar que un alumno ha empezado el proceso de reinscripción y requiere una carta de beca.',
                 video='https://www.youtube.com/embed/dQw4w9WgXcQ',
...
def reverse_func(apps, schema_editor):
    ...
    Tutorial.objects.using(db_alias).filter(titulo='¿Cómo aprovar un estudio?').delete()
    ...
    Tutorial.objects.using(db_alias).filter(titulo='¿Cómo lidear con el proceso de retroalimentación?').delete()
    Tutorial.objects.using(db_alias).filter(titulo='¿Que significan los diferentes estados del estudio socioeconómico?').delete()
