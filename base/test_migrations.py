...
class TestLoadTutorials(TestCase):
    ...
    def test_tutorials_created(self):
        """ Checks that all the tutorials where properly created.
        """
        ...
        self.assertTrue(Tutorial.objects.get(titulo='¿Cómo aprobar un estudio?'))
        ...
        self.assertTrue(Tutorial.objects.get(titulo='¿Cómo lidiar con el proceso de retroalimentación?'))
        self.assertTrue(Tutorial.objects.get(titulo='¿Qué significan los diferentes estados del estudio socioeconómico?'))
