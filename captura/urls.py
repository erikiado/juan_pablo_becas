...
from .views import capturista_dashboard, capture_study, add_answer_study, remove_answer_study, \
                   ...
                   upload_photo, get_form_delete_foto, delete_foto, save_upload_study, \
                   create_comentario
...
urlpatterns = [
    ...
    url(r'^upload-photo/(?P<id_estudio>[0-9]+)',
        upload_photo,
        name='upload_photo'),
    url(r'borrar-foto/(?P<id_foto>[0-9]+)',
        get_form_delete_foto, name='form_delete_foto'),
    url(r'borrar-foto/confirmar/(?P<id_foto>[0-9]+)',
        delete_foto, name='delete_foto'),
